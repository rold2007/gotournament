namespace GoTournament
{
    ...
    public class DuelInitializer : IDuelInitializer
    {
        ...
        public DuelInitializer(ISimpleInjectorWrapper simpleInjector, string name, string gamesCount)
        {
        ...
        {
            var scenario = this.configurationReader.ReadDuel(this.Name);
            int count;
        ...
        private void RunBotRunner(IGoBot botBlack, IGoBot botWhite, Duel tourn)
        {
            // var finished = false;
            var sync = new object();
